  ...
  updateExistingRoute = (evt) => {
    ...
    if (
      ...
      MapboxManager.getAddress(
        ...
        RouteManager.update(route).then(() =>
          this.props.history.push(`/routes/${this.state.id}`)
        );
      });
    }
  };
            ...
            <fieldset>
              <div className="route-form">
                ...
                <label htmlFor="directions">
                  <b>Route Directions, separated by line break</b>
                </label>
                <br />
                <textarea
                  required
